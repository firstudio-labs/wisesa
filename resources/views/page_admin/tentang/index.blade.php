                  ...
                  <tbody>
                    @if($tentang && $tentang->count() > 0)
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('tentang.show', $item->id) }}" class="btn btn-sm btn-info">Detail</a>
                          <a href="{{ route('tentang.edit', $item->id) }}" class="btn btn-sm btn-warning">Edit</a>
                          <form action="{{ route('tentang.destroy', $item->id) }}" method="POST" style="display:inline;" class="delete-form">
                              @csrf
                              @method('DELETE')
