            ...
            <div class="card-body">
              ...
              <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul', $produk->judul) }}" placeholder="Masukkan judul produk" />
                  @error('judul')
                ...
                <div class="form-group mb-3">
                  ...
                  <select class="form-select @error('master_kategori_produk_id') is-invalid @enderror" id="master_kategori_produk_id" name="master_kategori_produk_id">
                    ...
                    @foreach ($kategoriProduks as $kategori)
                      <option value="{{ $kategori->id }}" {{ old('master_kategori_produk_id', $produk->master_kategori_produk_id) == $kategori->id ? 'selected' : '' }}>
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="5" placeholder="Masukkan deskripsi produk">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                  @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
