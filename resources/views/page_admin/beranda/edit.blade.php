          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Form Edit Data Beranda</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Form Edit Data Beranda</h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="judul_utama" class="form-control @error('judul_utama') is-invalid @enderror" value="{{ old('judul_utama', $beranda->judul_utama) }}" required>
                      @error('judul_utama')
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="judul_sekunder" class="form-control @error('judul_sekunder') is-invalid @enderror" value="{{ old('judul_sekunder', $beranda->judul_sekunder) }}" required>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="slogan" class="form-control @error('slogan') is-invalid @enderror" value="{{ old('slogan', $beranda->slogan) }}" required>
                      @error('slogan')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="4" required>{{ old('keterangan', $beranda->keterangan) }}</textarea>
                      @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
