                ...
                <table id="simpletable" class="table table-striped table-bordered nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('beranda.show', $beranda->id) }}" class="btn btn-sm btn-info">Detail</a>
                        <a href="{{ route('beranda.edit', $beranda->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('beranda.destroy', $beranda->id) }}" method="POST" style="display:inline;" class="delete-form">
                            @csrf
                            @method('DELETE')
