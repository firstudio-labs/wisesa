                ...
                <table id="simpletable" class="table table-striped table-bordered nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('galeri.show', $galeri->id) }}" class="btn btn-sm btn-info">Detail</a>
                        <a href="{{ route('galeri.edit', $galeri->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('galeri.destroy', $galeri->id) }}" method="POST" style="display:inline;" class="delete-form">
                            @csrf
                            @method('DELETE')
