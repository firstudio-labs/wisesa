                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="posisi"
                                                ...
                                                value="{{ old('posisi', $tim->posisi) }}" placeholder="Masukkan posisi"
                                                required>
                                            @error('posisi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($tim->gambar)
                                                <div class="mt-2">
                                                    ...
                                                    <img src="{{ asset('upload/tim/' . $tim->gambar) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="quote" class="form-control @error('quote') is-invalid @enderror" rows="3"
                                                placeholder="Masukkan quote" required>{{ old('quote', $tim->quote) }}</textarea>
                                            @error('quote')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="instagram"
                                                ...
                                                value="{{ old('instagram', $tim->instagram) }}"
                                                placeholder="Masukkan link Instagram" required>
                                            @error('instagram')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="linkedin"
                                                ...
                                                value="{{ old('linkedin', $tim->linkedin) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="facebook"
                                                ...
                                                value="{{ old('facebook', $tim->facebook) }}"
                                                placeholder="Masukkan link Facebook" required>
                                            @error('facebook')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="whatsapp"
                                                ...
                                                value="{{ old('whatsapp', $tim->whatsapp) }}"
