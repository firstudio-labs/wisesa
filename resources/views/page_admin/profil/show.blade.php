                ...
                <div class="col-12">
                  ...
                  <div class="d-flex flex-wrap gap-2">
                    @if($profil->instagram_perusahaan)
                      <a href="https://instagram.com/{{ $profil->instagram_perusahaan }}" target="_blank" class="btn btn-icon btn-outline-danger btn-sm" title="Instagram">
                        <i class="fab fa-instagram"></i>
                      </a>
                    @endif
                    @if($profil->facebook_perusahaan)
                      <a href="https://facebook.com/{{ $profil->facebook_perusahaan }}" target="_blank" class="btn btn-icon btn-outline-primary btn-sm" title="Facebook">
                        <i class="fab fa-facebook-f"></i>
                      </a>
                    @endif
                    @if($profil->twitter_perusahaan)
                      <a href="https://twitter.com/{{ $profil->twitter_perusahaan }}" target="_blank" class="btn btn-icon btn-outline-info btn-sm" title="Twitter">
                        <i class="fab fa-twitter"></i>
                      </a>
                    @endif
                    @if($profil->linkedin_perusahaan)
                      <a href="https://linkedin.com/in/{{ $profil->linkedin_perusahaan }}" target="_blank" class="btn btn-icon btn-outline-primary btn-sm" title="LinkedIn">
