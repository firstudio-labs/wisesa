                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_perusahaan" class="form-control @error('nama_perusahaan') is-invalid @enderror" value="{{ old('nama_perusahaan', $profil->nama_perusahaan) }}" required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="no_telp_perusahaan" class="form-control @error('no_telp_perusahaan') is-invalid @enderror" value="{{ old('no_telp_perusahaan', $profil->no_telp_perusahaan) }}" required>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="alamat_perusahaan" class="form-control @error('alamat_perusahaan') is-invalid @enderror" placeholder="Masukkan alamat perusahaan" required>{{ old('alamat_perusahaan', $profil->alamat_perusahaan) }}</textarea>
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" name="email_perusahaan" class="form-control @error('email_perusahaan') is-invalid @enderror" value="{{ old('email_perusahaan', $profil->email_perusahaan) }}" required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="instagram_perusahaan" class="form-control @error('instagram_perusahaan') is-invalid @enderror" value="{{ old('instagram_perusahaan', $profil->instagram_perusahaan) }}" placeholder="Masukkan username Instagram">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="facebook_perusahaan" class="form-control @error('facebook_perusahaan') is-invalid @enderror" value="{{ old('facebook_perusahaan', $profil->facebook_perusahaan) }}" placeholder="Masukkan username Facebook">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="twitter_perusahaan" class="form-control @error('twitter_perusahaan') is-invalid @enderror" value="{{ old('twitter_perusahaan', $profil->twitter_perusahaan) }}" placeholder="Masukkan username Twitter">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude', $profil->latitude) }}" placeholder="Masukkan latitude" readonly>
                      @error('latitude')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="form-group">
                      ...
                      <input type="text" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude', $profil->longitude) }}" placeholder="Masukkan longitude" readonly>
                      @error('longitude')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
