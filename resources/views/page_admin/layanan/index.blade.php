                ...
                <table id="simpletable" class="table table-striped table-bordered nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @if ($layanan->gambar)
                          <img src="{{ asset('storage/layanan/' . $layanan->gambar) }}" alt="Gambar {{ $layanan->judul }}" class="img-thumbnail" style="max-height: 100px;">
                        @else
                      ...
                      <td>
                        <a href="{{ route('layanan.show', $layanan->id) }}" class="btn btn-sm btn-info">Detail</a>
                        <a href="{{ route('layanan.edit', $layanan->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('layanan.destroy', $layanan->id) }}" method="POST" style="display:inline;" class="delete-form">
                          @csrf
                          @method('DELETE')
