...
<head>
    ...
    <!--favicon-->
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('web') }}/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('web') }}/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('web') }}/favicons/favicon-16x16.png">
    <link rel="manifest" href="{{ asset('web') }}/favicons/site.webmanifest">
...
<body class="webpage">
    ...
    <script src="{{ asset('web') }}/js/libs/jquery.fancybox.min.js"></script>
    <script src="{{ asset('web') }}/js/libs/animsition.min.js"></script>
    <script src="{{ asset('web') }}/js/libs/aos.js"></script>
    <script src="{{ asset('web') }}/js/libs/swiper-bundle.min.js"></script>
    <script src="{{ asset('web') }}/js/libs/jquery.easy_number_animate.js"></script>
    <script src="{{ asset('web') }}/js/libs/jquery.marquee.min.js"></script>
    <script src="{{ asset('web') }}/js/libs/isotope.pkgd.min.js"></script>
    <script src="{{ asset('web') }}/js/libs/packery.pkgd.min.js"></script>
    <script src="{{ asset('web') }}/js/libs/packery-mode.pkgd.min.js"></script>
    <script src="{{ asset('web') }}/js/libs/jquery.pagepiling.js"></script>
