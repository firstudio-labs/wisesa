...
<head>
    ...
    <title>Register | StarterKit-v2</title>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="d-grid gap-2 mb-3">
                          <a href="{{ route('google.login') }}" class="btn btn-light-primary bg-light text-muted">
                            <img src="{{ asset('admin') }}/assets/images/authentication/google.svg" alt="img"> <span class="d-none d-sm-inline-block"> Daftar dengan Google</span>
                          </a>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan nama lengkap" required>
                              @error('name')
                            ...
                            <div class="mb-3">
                              ...
                              <input type="email" id="email" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="Masukkan alamat email" required>
                              @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                            </div>
                            <div class="mb-3">
                              ...
                              <div class="input-group">
                                <input type="password" id="password" name="password" class="form-control border-end-0 @error('password') is-invalid @enderror" placeholder="Buat password yang kuat" required>
                            ...
                            <div class="mb-3">
                              ...
                              <div class="input-group">
                                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control border-end-0 @error('password_confirmation') is-invalid @enderror" placeholder="Ulangi password" required>
                                <button type="button" class="btn btn-outline-secondary border-start-0" data-password-toggle aria-label="Tampilkan password" aria-pressed="false">
                                  <ion-icon name="eye-outline"></ion-icon>
                                </button>
                              </div>
