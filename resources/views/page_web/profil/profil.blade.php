...
<style>
    ...
    @media (min-width: 992px) {
        .save-profile-btn:hover, .save-profile-btn:focus {
                ...
                <div class="profile-form-container">
                    <form class="profile-form" id="profileForm" action="{{ route('profil.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="profile-photo-input-container">
                            <div class="profile-photo-preview" id="profile-photo-preview" onclick="document.getElementById('profile-photo').click()">
                                @php
                                ...
                                @endphp
                                <img src="{{ $srcFoto }}" alt="Foto Profil" class="profile-photo-img" id="profile-photo-img">
                            ...
                            <input type="file" id="profile-photo" name="foto_profile" accept="image/*" style="display: none !important;" onchange="handlePhotoChange(this)">
                        ...
                        <div class="field">
                            <input type="text" id="fullname" name="name" value="{{ $data->name ?? auth()->user()->name ?? '' }}" placeholder=" " required>
                        ...
                        <div class="field">
                            <input type="text" id="username" name="username" value="{{ $data->username ?? auth()->user()->username ?? '' }}" placeholder=" " required>
                        ...
                        <div class="field">
                            <input type="email" id="email" name="email" value="{{ $data->email ?? auth()->user()->email ?? '' }}" placeholder=" " required>
                        ...
                        <div class="field">
                            <input type="tel" id="phone" name="no_wa" value="{{ $data->no_wa ?? auth()->user()->no_wa ?? '' }}" placeholder=" " required>
